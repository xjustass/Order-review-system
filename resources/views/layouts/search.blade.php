...
<div class="bg-secondary font-body">
    ...
    <div class="max-w-screen-xl min-h-screen mx-0 lg:mx-auto flex flex-col text-center">
        ...
        <div class="font-body items-center justify-center ">
            <form class="rounded-full overflow-hidden inline-flex focus-within:ring-electric  focus-within:ring-2">

                <input type="text" class="py-2 text-xs px-2 sm:px-4 sm:py-4 w-48 sm:w-96 focus:outline-none" placeholder="Užsakymo kodas">
